...
<div id="content" class="content">
    <div class="page-title-css">
        <div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Restore Referensi Barang</li>
            </ol>
        </div>
        <div>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="panel panel-inverse" data-sortable-id="ui-upload-restore-referensi-barang">
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="panel panel-inverse" data-sortable-id="ui-restore-referensi-barang">
                <div class="panel-heading">
                    <h4 class="panel-title"><i class="fas fa-info-circle"></i> [Restore] Referensi Barang</h4>
                    <?php include "include/panel-row.php"; ?>
                </div>
                <div class="panel-body text-inverse">
