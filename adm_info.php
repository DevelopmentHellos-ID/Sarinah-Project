...
if (isset($_POST["SaveInfo"])) {
    ...
    $dataCek = $dbcon->query("SELECT IDUNIQ FROM tbl_users WHERE USER_NAME='$InputUsername'");
    $resultCek = mysqli_fetch_array($dataCek);
    $InputIDUNIQ              = $resultCek['IDUNIQ'];
    ...
    $query .= $dbcon->query("INSERT INTO tbl_aktifitas
                                         ...
                                         VALUES
                                         ('','$InputIDUNIQ','$InputUsername','$InputModul','$InputDescription','$InputAction','$InputDate')");
    ...
    <div class="page-title-css">
        <div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Setting Informasi</li>
            </ol>
        </div>
        <div>
        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse" data-sortable-id="data-table">
                <div class="panel-heading">
                    <h4 class="panel-title">[Administrator Tools] Setting Informasi</h4>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group row">
                                <div class="col-md-7 offset-md-3">
                                    <button type="submit" class="btn btn-sm btn-primary m-r-5" name="SaveInfo"><i class="fa fa-save"></i> Simpan</button>
                                </div>
                            </div>
                        </fieldset>
                    </form>
