		...
		<ul class="nav">
			...
			<li class="has-sub">
				...
				<ul class="sub-menu">
					...
					<li><a href="../template_angularjs8/index.html">ANGULAR JS 8 <i class="fa fa-paper-plane text-theme"></i></a></li>
					<li><a href="../template_laravel/index.html">LARAVEL <i class="fa fa-paper-plane text-theme"></i></a></li>
					<li><a href="../template_vuejs/index.html">VUE JS <i class="fa fa-paper-plane text-theme"></i></a></li>
					<li><a href="../template_reactjs/index.html">REACT JS <i class="fa fa-paper-plane text-theme"></i></a></li>
					<li><a href="../template_material/index.html">MATERIAL DESIGN</a></li>
					<li><a href="../template_apple/index.html">APPLE DESIGN</a></li>
					<li><a href="../template_transparent/index.html">TRANSPARENT DESIGN <i class="fa fa-paper-plane text-theme"></i></a></li>
					<li><a href="../template_facebook/index.html">FACEBOOK DESIGN <i class="fa fa-paper-plane text-theme"></i></a></li>
				</ul>
			</li>
			<li class="has-sub">
				<a href="javascript:;">
